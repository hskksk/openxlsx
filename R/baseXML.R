...
gen_databar_extlst <- function(guid, sqref, posColour, negColour, values, border, gradient){
  ...
  if(is.null(values)){
    ...
    xml <- sprintf('<x14:conditionalFormatting xmlns:xm="http://schemas.microsoft.com/office/excel/2006/main">
                      %s
                      ...
                      </x14:dataBar></x14:cfRule><xm:sqref>%s</xm:sqref></x14:conditionalFormatting>', xml, posColour, negColour, negColour, sqref)
  }else{
    ...
    xml <- sprintf('<x14:conditionalFormatting xmlns:xm="http://schemas.microsoft.com/office/excel/2006/main">
                      ...
                      </x14:dataBar></x14:cfRule><xm:sqref>%s</xm:sqref></x14:conditionalFormatting>', xml, values[[1]], values[[2]], posColour, negColour, negColour, sqref)
